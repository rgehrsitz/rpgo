...
// CalculateAnnualPartBCost calculates annual Medicare Part B cost including IRMAA
func (mc *MedicareCalculator) CalculateAnnualPartBCost(magi decimal.Decimal, isMarriedFilingJointly bool) decimal.Decimal {
	monthlyPremium := mc.CalculatePartBPremium(magi, isMarriedFilingJointly)
	return monthlyPremium.Mul(decimal.NewFromInt(12))
}
